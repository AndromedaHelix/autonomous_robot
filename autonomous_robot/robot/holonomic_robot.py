...
from autonomous_robot.robot.kinematics import Kinematics


class HolonomicRobot:
    def __init__(self, motor1 : Motor, motor2 : Motor, motor3 : Motor, motor4 : Motor):
    
        self.Kinematics = Kinematics(RobotConfig(0.05, 0.26))
    ...
    def moveRobot (self, movement : Twist):
        ...
        wheel_velocities : List[float] = self.Kinematics.getWheelsAngularVelocities(RobotVelocity(movement.linear.x , movement.linear.y, movement.angular.z))
